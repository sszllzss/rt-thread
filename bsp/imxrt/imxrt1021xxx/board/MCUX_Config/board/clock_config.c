...
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 39.6 MHz}
...
- {id: SEMC_CLK_ROOT.outFreq, value: 79.2 MHz}
...
- {id: CCM.PERCLK_PODF.scale, value: '33', locked: true}
...
- {id: CCM_ANALOG.PLL2_PFD3_DIV.scale, value: '24'}
sources:
